...
import { GraduationCap, Lock, Mail, User, AlertCircle, CheckCircle, Shield, Sparkles } from "lucide-react";
...
export default function SignupPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#0a0a0f] p-4 relative overflow-hidden">
      ...
      >
        <Card className="border-white/5 bg-[#111827]/80 backdrop-blur-xl shadow-2xl shadow-cyan-500/5">
          <CardHeader className="space-y-3 text-center">
            ...
            <CardDescription className="text-white/50">Join Sveekruth AI Intelligence Layer</CardDescription>
          </CardHeader>
            ...
            <CardContent className="space-y-4">
              ...
              {success && (
                <motion.div
                  initial={{ opacity: 0, y: -10 }}
                  animate={{ opacity: 1, y: 0 }}
                  className="flex items-center gap-2 rounded-lg bg-emerald-500/10 border border-emerald-500/20 p-3 text-sm text-emerald-400"
                >
